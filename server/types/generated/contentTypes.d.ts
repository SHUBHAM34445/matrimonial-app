...
export interface ApiStaticContentStaticContent extends Struct.SingleTypeSchema {
...
export interface ApiSuccessStorySuccessStory
  ...
  attributes: {
    coupleName: Schema.Attribute.String;
    couplePhoto: Schema.Attribute.Media<'images' | 'files'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    weddingDate: Schema.Attribute.Date;
  };
}
...
export interface ApiUserProfileUserProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contactNumber: Schema.Attribute.String & Schema.Attribute.Unique;
    country: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateOfBirth: Schema.Attribute.Date;
    diet: Schema.Attribute.Enumeration<
      ['Vegetarian', 'Non-Vegetarian', 'Vegan', 'Eggetarian']
    >;
    drinkingHabits: Schema.Attribute.Enumeration<
    ...
    partnerPreferences: Schema.Attribute.JSON;
    profession: Schema.Attribute.String;
    profileCompletionPercentage: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
    profilePicture: Schema.Attribute.Media<'files' | 'images'>;
    publishedAt: Schema.Attribute.DateTime;
    religion: Schema.Attribute.String;
    smokingHabits: Schema.Attribute.Enumeration<
